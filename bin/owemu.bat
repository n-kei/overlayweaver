...
set CLASSPATH=%BUILD_DIR%;%BUILD_DIR%\main;%BUILD_DIR%\test;%TARGET_DIR%\overlayweaver.jar;%LIB_DIR%\je-6.4.9.jar;%LIB_DIR%\xmlrpc-common-3.1.3.jar;%LIB_DIR%\xmlrpc-server-3.1.3.jar;%LIB_DIR%\ws-commons-util-1.0.2.jar;%LIB_DIR%\commons-cli-1.3.1.jar
